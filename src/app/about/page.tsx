    ...
    <>
      ...
      <section className="relative bg-[#0a0907] text-white overflow-hidden border-b border-[#17130c]">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-20 md:pt-28 md:pb-28">
          ...
          <h1 className="font-display text-4xl md:text-6xl font-semibold mb-5 max-w-3xl leading-[1.1]">About Hotel Riyansh</h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <h2 className="font-display text-3xl md:text-4xl font-semibold text-[#f2ecdf] mb-5">A warm home on Dumka Road</h2>
            ...
            <div className="bg-gradient-to-br from-[#211b13] via-[#17140f] to-[#0d0b08] border border-[#312b1e] rounded-2xl p-10 flex flex-col items-center justify-center text-center min-h-[300px]">
              <span className="gold-gradient-text font-display text-6xl font-semibold mb-2">{HOTEL_INFO.established}</span>
              <span className="text-[#c6bda7] text-lg tracking-widest uppercase mb-1">Established</span>
              <div className="rule-gold w-16 my-5" />
              <p className="text-[#8f8672] text-sm leading-relaxed max-w-xs">
                {HOTEL_INFO.address}
              </p>
            </div>
          </div>

          <div className="bg-gradient-to-br from-[#211b13] via-[#17140f] to-[#0d0b08] border border-[#221d14] rounded-2xl p-8 md:p-12 mb-20">
            <div className="max-w-3xl mx-auto text-center">
              <p className="eyebrow mb-4">Our Mission</p>
              <h2 className="font-display text-2xl md:text-3xl font-semibold text-[#f2ecdf] mb-5">A home away from home</h2>
          ...
          <div className="mb-12">
            <div className="text-center mb-12">
              ...
              <h2 className="font-display text-2xl md:text-3xl font-semibold text-[#f2ecdf]">What we stand for</h2>
              <div className="rule-gold w-16 mx-auto mt-5" />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((val) => (
                <div key={val.title} className="bg-[#14120e] border border-[#221d14] rounded-xl p-6 text-center hover:border-[#3a3427] hover:shadow-gold transition-all">
                  ...
                  <h3 className="font-display text-lg text-[#f2ecdf] mb-2">{val.title}</h3>
                  <p className="text-sm text-[#8f8672] leading-relaxed">{val.description}</p>
                </div>
              ))}
            </div>
          </div>
